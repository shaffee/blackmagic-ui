 ...
 */
 draw2d.shape.analog.Nmos4Transistor = draw2d.shape.analog.base.extend({

    NAME:"draw2d.shape.analog.Nmos4Transistor",
    Drain:'',
    Source:'',
    Gate:'',
    Bulk:'',
    ...
    init:function(width, height){
        ...
        this.inputLocator = new draw2d.shape.analog.Nmos4Transistor.inputLocator();
	    ...
	    var labelLocator = new draw2d.shape.analog.Nmos4Transistor.labelLocator();
	...
	ngSpiceCommand: function(nodes,deviceIndex)
	{
		...
		this.model = ".model NmostModel"+deviceIndex+" NMOS";
...
draw2d.shape.analog.Nmos4Transistor.labelLocator = draw2d.layout.locator.Locator.extend({
	init:function( ){
	  this._super();
	},    
	relocate:function(index, figure){
