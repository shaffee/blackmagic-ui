 ...
 */
 draw2d.shape.analog.norGate2 = draw2d.shape.analog.digital.extend({

    NAME:"draw2d.shape.analog.norGate2",
    input1:"",
    input2:"",
	output:"",
	operation:"NOR",
    ...
    init:function(width, height){
        ...
        this.inputLocator = new draw2d.shape.analog.norGate2.inputLocator();
        this.outputLocator = new draw2d.shape.analog.norGate2.outputLocator();
...
// custom locator for the special design of the ResistorBridge Input area
draw2d.shape.analog.norGate2.outputLocator = draw2d.layout.locator.Locator.extend({
    NAME : 'draw2d.shape.analog.norGate2.outputLocator',
    init:function( ){
        this._super();
    },    
    relocate:function(index, figure){
