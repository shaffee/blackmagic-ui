 ...
 */
 draw2d.shape.analog.count4bit = draw2d.shape.analog.digital.extend({

    NAME:"draw2d.shape.analog.count4bit",
    clock:'',
    A0:'',
    A1:'',
    A2:'',
  ...
  timer10msTick: function(){    
    ...
    init:function(width, height){
        ...
        this.inputLocator = new draw2d.shape.analog.count4bit.inputLocator();
        this.outputLocator = new draw2d.shape.analog.count4bit.outputLocator();
...
draw2d.shape.analog.count4bit.inputLocator = draw2d.layout.locator.Locator.extend({
	NAME : 'draw2d.shape.analog.count4bit.inputLocator',
	init:function( ){
		this._super();
	},    
...
// custom locator for the special design of the ResistorBridge Input area
draw2d.shape.analog.count4bit.outputLocator = draw2d.layout.locator.Locator.extend({
	NAME : 'draw2d.shape.analog.count4bit.outputLocator',
	init:function( ){
		this._super();
	},    
	relocate:function(index, figure){
